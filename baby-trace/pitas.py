...
def start_trace(binary):
	...
	simgr.explore(find=p.loader.find_symbol('main').rebased_addr).move('found', 'active') #gets to main, moves it to active
...
def resume_trace(binary, trace=None):
	...
	def step():
		...
		for _ in range(num_steps):
			simgr.step()
			#print("rip", str(simgr.one_active.regs.rip))
			#print("rax", str(simgr.one_active.regs.rax))
...
def main():
    ...
    # Options are headerquery and /bin/false
